...
var MobileMenu = function () {
  ...
  _createClass(MobileMenu, [{
    ...
    value: function events() {
      //Below is the events associated with above class
...
var StickyHeader = function () {
  ...
  _createClass(StickyHeader, [{
    ...
    value: function addSmoothScrolling() {
      //function that adds smoothScroll npm package to our headerlink navs
...
var Modal = function () {
	...
	_createClass(Modal, [{
		...
		value: function events() {
			...
			(0, _jquery2.default)(document).keyup(this.keyPressHandler.bind(this)); //if doc gets keyup use keypress handler func with this bound to Modal
		}
	}, {
		key: "keyPressHandler",
		value: function keyPressHandler(e) {
			if (e.keyCode == 27) {
				//if elements keycode is 27 (esc key) call close modal function (close modal)
				this.closeModal();
			}
		}
	}, {
			...
			this.itemsToReveal.each(function () {
				...
				new Waypoint({
					...
					handler: function handler() {
						//function adds a class to make it visible
